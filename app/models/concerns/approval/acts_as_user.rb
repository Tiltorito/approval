module Approval
  module ActsAsUser
    ...
    included do
      has_many :approval_requests, class_name: :"Approval::Request", foreign_key: :request_user_id, dependent: :destroy
      has_many :approval_comments, class_name: :"Approval::Comment", foreign_key: :user_id, dependent: :destroy
    end
